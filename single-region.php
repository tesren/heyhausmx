    ...
    <article>
        ...
        <?php if ( have_posts() ): ?>
            ...
            <?php while( have_posts() ): the_post();?>
                ...
                <?php $developments = get_field('devs_region'); ?>

                <?php if($developments): ?>
                    <h3 class="text-center gold-text fs-1 fw-light mb-5"><?php pll_e('Desarrollos en la Región');?></h3>
                    <div class="position-relative py-5 mb-6 bg-blue">
                        ...
                        <div id="carouselExample" class="carousel slide py-5">
                            <div class="carousel-inner">
                                <?php $i=0; foreach($developments as $dev):?>
